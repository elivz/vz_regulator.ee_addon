...
class Vz_regulator_ft extends EE_Fieldtype {
    ...
    .vz_regulator_field:invalid, .vz_regulator_field:invalid:focus { color: #c11; border-color: #a66; }
    .vz_regulator_field.invalid, .vz_regulator_field.invalid:focus { color: #c11; border-color: #a66; }
    ...
    .vz_regulator_field:invalid + .vz_regulator_hint { top: 26px; }
    .vz_regulator_field.invalid + .vz_regulator_hint { top: 26px; }
    .vz_regulator_field:invalid:focus + .vz_regulator_hint { opacity: 1; }
    .vz_regulator_field.invalid:focus + .vz_regulator_hint { opacity: 1; }
